...
// returning errors and stop signals. The Engine will issue a ReadJob with
// a context and sends it to the readers. The NewReadJob function injects
// a unique ID into the context and returns it.
...
// StopChannel is used to signal each component when to stop.
// They should return a signal back when they have finished their work.
