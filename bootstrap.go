...
func StartEngines(ctx context.Context, log internal.FieldLogger, conf *config.ConfMap) (chan struct{}, error) {
...
func getEngine(ctx context.Context, log internal.FieldLogger, conf *config.ConfMap, recorder string, readers []string) (*Engine, error) {
