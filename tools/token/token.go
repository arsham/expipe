...
// Package token contains necessary logic for passing messages. The Engine will
// issue a token.Context with a unique ID and sends it to the reader. The New
// function injects a unique ID into the context and returns it. All
// readers/recorders should use this ID for returning errors and logging.
package token
...
// ID is a unique ID. Only the Engine issues this ID and you should pass it
// along as you receive.
type ID uuid.UUID
